...
1.  **Clone Repository**
    ```bash
    git clone # ☕ Tiban Kaffe - Django Coffee Shop Website
...
1.  **Clone Repository**
    ```bash
    git clone [https://github.com/USERNAME_KAMU/tiban-kaffe-django.git](https://github.com/USERNAME_KAMU/tiban-kaffe-django.git)
    cd tiban-kaffe-django
    ```
...
cd kedaikopi
python manage.py startapp menuv
    cd tiban-kaffe-django
    ```
